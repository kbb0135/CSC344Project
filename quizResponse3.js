...
if(docSnap.exists()) {
    ...
    document.getElementById("a1").innerHTML = docSnap.data().b
    document.getElementById("a2").innerHTML = docSnap.data().g
    document.getElementById("a3").innerHTML = docSnap.data().l
